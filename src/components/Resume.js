        ...
        <div className="flex items-start">
          ...
          <div className="ml-4">
            ...
            <div className="flex flex-col text-left">
              ...
              <p className="text-sm text-[#9a9da3]">Sydney, Australia</p>
            </div>
      ...
      <div className="mb-8">
        ...
        <div className="flex items-start">
          ...
          <div className="ml-4">
            ...
            <p className="text-sm text-[#9a9da3] text-left">Bachelor of Commerce(Finance) & Bachelor of Engineering(Software)(Honours)</p>
            <p className="text-sm text-[#9a9da3] text-left">Sydney, Australia</p>
          </div>
        </div>
        ...
        <div className="flex items-start mt-8">
          ...
          <div className="ml-4">
            ...
            <p className="text-sm text-[#9a9da3] text-left">High School Diploma</p>
            <p className="text-sm text-[#9a9da3] text-left">Sydney, Australia</p>
          </div>
        </div>
      </div>
