...
const Header = () => {
  return (
    <motion.header className="relative flex items-center justify-between bg-[#23262b] text-white p-4 rounded-3xl mt-12 mr-8">
      ...
      {/* Vertical Divider */}
      <div className="border-l border-gray-600 h-24 mx-4"></div>
